...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda_ds', type=float, default=3,
    ...
    parser.add_argument('--inp_dir', type=str, default='./female',
                        help='input directory when aligning faces')
    parser.add_argument('--out_dir', type=str, default='./female',
